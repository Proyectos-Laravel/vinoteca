        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="category_id" class="block text-white text-sm font-bold mb-2">
                            Categoria
                        </label>
                        <select 
                            name="category_id" 
                    ...
                    <div class="mb-4">
                        <label for="price" class="block text-white text-sm font-bold mb-2">
                            Precio
                        </label>
                        <input 
                            type="number"
                    ...
                    <div class="mb-4">
                        <label for="stock" class="block text-white text-sm font-bold mb-2">
                            Stock
                        </label>
                        <input 
                            type="number"
                    ...
                    <div class="mb-4">
                        <label for="image" class="block text-gray-700 dark:text-white text-sm font-bold mb-2">
                            Imagen
                        </label>
                        <input 
                            type="file"
